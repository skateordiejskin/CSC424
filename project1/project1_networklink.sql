...
--
-- Dumping data for table `networklink`
--

LOCK TABLES `networklink` WRITE;
/*!40000 ALTER TABLE `networklink` DISABLE KEYS */;
INSERT INTO `networklink` VALUES (1,1);
/*!40000 ALTER TABLE `networklink` ENABLE KEYS */;
UNLOCK TABLES;
